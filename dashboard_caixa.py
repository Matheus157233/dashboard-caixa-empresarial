...
CLIENTES = {
    "JRTS": {
        "senha_hash": _h("JRTS1234"), "nome": "Empresa Demo Empresarial",
...
# ══════════════════════════════════════════════════════════════════════════════
tab_visao, tab_emp, tab_lembretes, tab_relatorios = st.tabs(
    ["📊 Visão Geral", "💎 Painel Empresarial", "🔔 Lembretes", "📄 Relatórios"]
)
...
# ────────────────────────────────────────────────────────────────────────────
#  ABA 2 — PAINEL EMPRESARIAL: tudo que é exclusivo do plano empresarial
# ────────────────────────────────────────────────────────────────────────────
with tab_emp:
